...
Streamable HTTP con respuestas JSON, sin SSE persistente ni sesiones de transporte. Versiones admitidas: 2025-11-25, 2025-06-18 y 2025-03-26. Métodos: initialize, ping, tools/list, tools/call; notificaciones initialized/cancelled reciben 202. GET autenticado recibe 405 al no ofrecer streaming; sin token, 401. No se ejecutan herramientas enviadas como notificaciones.
...
Instalador: installer_whoami, installer_profile, installer_inbox, installer_accept, installer_resolve, installer_notification_read.
