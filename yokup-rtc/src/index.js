...
async function applySchema(env) {
  ...
  await env.DB.exec(unaLinea(SUPERVISOR_IDENTITY_TRACKS_SQL));
...
// Tarjeta que sustituye a una evidencia retirada (640×360, PNG). Generada una vez; el
// motivo y la fecha no van en la imagen sino en el historial de la misión.
const RETIRADA_PNG_B64 = "";
...
var worker_app = {
  async fetch(req, env, ctx) {
    ...
    if (url.pathname === "/fleet/progress" && req.method === "POST") {
      try {
        ...
        if (img) {
          ...
          // Cada captura de proceso queda en el historial con misión y autor: sin esto, una
          // imagen subida por error no se podía ni localizar (NeoMBP14, 7-sep-2026: hubo que
          // listar el bucket entero por tamaño para encontrarla). Es lo que permite retirarla
          // después con /fleet/evidence/retract.
          await addEvent(env, mid, "evidence", actor.actor, "📷 Captura de proceso (" + (liveKind || "process") + "): " + img);
    ...
    // RETIRAR UNA EVIDENCIA (Carlos, 7-sep-2026: «¿se puede mejorar el MCP para borrar
    // errores como la pantalla que comentas?»). Un agente subió por error una captura de
    // pantalla completa con una ventana ajena; la única salida era /fleet/media/delete a
    // pelo, sin identidad ni rastro y conociendo la clave. Esto es lo mismo con contrato:
    //   · solo el AUTOR de la misión (misma persona y equipo que el assignee) y con MOTIVO;
    //   · solo imágenes que ESA misión referencia (live_shot, proof_image o un evento suyo);
    //   · no se borra el hecho: el objeto se sustituye por una tarjeta «evidencia retirada»
    //     (la URL sigue resolviendo, nadie ve un 404 ni el contenido), la referencia viva
    //     se limpia y queda un evento con quién, cuándo y por qué.
    if (url.pathname === "/fleet/evidence/retract" && req.method === "POST") {
      try {
        await ensureSchema(env);
        if (!env.MEDIA) return json({ ok: false, error: "sin bucket MEDIA" }, 500);
        let b; try { b = await req.json(); } catch { return json({ ok: false, error: "bad json" }, 400); }
        const mid = await resolveFleetMissionReference(env, b.mission || b.id);
        if (!mid) return json({ ok: false, error: "mission requerida" }, 400);
        const t = await env.DB.prepare("SELECT id,assignee,loc,status,live_shot,proof_image FROM tickets WHERE id=?").bind(mid).first();
        if (!t) return json({ ok: false, error: "la misión " + mid + " no existe", applied: false }, 404);
        const actor = validateMissionActor(t, b.owner || b.by || b.agent);
        if (!actor.ok) return json({ ok: false, code: "owner_mismatch", error: actor.error, expected_assignee: actor.expected, received_owner: actor.actor, applied: false }, 403);
        const reason = String(b.reason || "").trim().slice(0, 300);
        if (reason.length < 8) return json({ ok: false, code: "reason_required", error: "reason obligatorio (≥ 8 caracteres): queda en el historial de la misión", applied: false }, 400);
        let key = String(b.image || b.url || b.key || "").trim();
        try { if (/^https?:\/\//i.test(key)) key = new URL(key).pathname; } catch (e) {}
        key = key.replace(/^\/+/, "").replace(/^media\//, "");
        if (!/^fleet\/[A-Za-z0-9._-]+$/.test(key)) return json({ ok: false, code: "bad_image", error: "image debe ser una URL/clave de /media/fleet/…", applied: false }, 400);
        const publicUrl = url.origin + "/media/" + key;
        const referenced = (t.live_shot && t.live_shot.includes(key)) || (t.proof_image && t.proof_image.includes(key)) ||
          !!(await env.DB.prepare("SELECT id FROM events WHERE ticket_id=? AND text LIKE ? LIMIT 1").bind(mid, "%" + key + "%").first());
        if (!referenced) return json({ ok: false, code: "not_referenced", error: "esa imagen no consta en la misión " + mid + " (ni live_shot, ni prueba final, ni historial): no se retira lo que no es tuyo", applied: false }, 409);
        const existed = !!(await env.MEDIA.head(key));
        const bin = Uint8Array.from(atob(RETIRADA_PNG_B64), (c) => c.charCodeAt(0));
        await env.MEDIA.put(key, bin, { httpMetadata: { contentType: "image/png" }, customMetadata: { retracted_by: actor.actor, retracted_at: String(Date.now()), reason } });
        const cleared = [];
        if (t.live_shot && t.live_shot.includes(key)) { await env.DB.prepare("UPDATE tickets SET live_shot=NULL,live_kind=NULL,updated_at=? WHERE id=?").bind(Date.now(), mid).run(); cleared.push("live_shot"); }
        if (t.proof_image && t.proof_image.includes(key)) { await env.DB.prepare("UPDATE tickets SET proof_kind='retracted',updated_at=? WHERE id=?").bind(Date.now(), mid).run(); cleared.push("proof_image (queda la tarjeta; proof_kind=retracted)"); }
        await addEvent(env, mid, "retract", actor.actor, "🗑 Evidencia retirada por su autor · motivo: " + reason + " · " + publicUrl);
        return json({ ok: true, mission: mid, key, url: publicUrl, existed, replaced_with: "tarjeta «evidencia retirada»", references_cleared: cleared, by: actor.actor, reason });
      } catch (e) { return json({ ok: false, error: String(e && e.message || e), applied: false }, 500); }
    }
