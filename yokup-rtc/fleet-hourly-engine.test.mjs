...
test('ACK real Desktop entregado conserva Learning pendiente hasta verificar cápsula',async()=>{
  ...
  const context={readDesktopResult:async()=>({status:'done',delivered:true})};
