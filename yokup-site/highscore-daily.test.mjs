...
test("el ranking distingue actividad actual de los totales históricos", () => {
  assert.match(html, /datos = \{ tareas: \[\], tareasFresh: false, actividad: \[\],[^}]*misiones: \[\], ideas: \[\], decisiones: \[\], proyectos: \[\],[^}]*declaracionesPrincipales: \[\], controlMachines: \[\], presenceNow: 0, presenceAvailable: false, turnos: null \}/);
