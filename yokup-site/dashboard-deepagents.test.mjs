...
test('ficha multiruntime opera y muestra modo sólo del destino elegido; perderlo obliga a elegir de nuevo',()=>{
 ...
 assert.match(html,/Codex real/);assert.doesNotMatch(html,/class="llm">OpenCode real/);assert.match(html,/Codex · Cerrado/);assert.match(html,/Estado de la ficha: Abierto/);
