...
test("la calle stale indica actividad sin confirmar y no compite", () => {
  ...
  assert.match(html, /"Trabajo en curso · actividad sin confirmar"/);
  ...
  assert.match(html, /carril\.classList\.remove\("cruzando", "finished", "cosmetic-finished", "race-winner", "race-loser"\)/);
});
