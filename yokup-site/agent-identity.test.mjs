...
assert.equal(id.scoped("Niobe","Mac Mini"),"NiobeMacMini");
assert.equal(id.scoped("SubNiobeMini",""),"SubNiobeMacMini");
assert.equal(id.scoped("InfraNiobeMini",""),"InfraNiobeMacMini");
assert.equal(id.same("NiobeMacMini","OraculoMacMini"),false);
