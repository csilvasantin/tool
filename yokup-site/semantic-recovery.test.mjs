...
test("equipo recupera identidad, los dos responsables, web y seguimiento",async()=>{const s=await read("./equipo.html");for(const m of ["nombreVisibleAg","responsablesDe","silicon_responsible","carbon_responsible","normalizaWebProyecto","fechaSeguimiento","pintaNotas","abrirNotas","/projects/notes","notasMod"])assert.match(s,new RegExp(m.replace("/","\\/")));assert.doesNotMatch(s,/responsibles_text|Responsables y roles/);});
