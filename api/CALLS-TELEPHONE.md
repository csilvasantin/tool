...
Para la nueva cuenta trial de Twilio, configurar `TWILIO_TRIAL_MODE=true`: enviar únicamente To, From, Url y StatusCallback, conforme al ejemplo de su consola. Los parámetros de producción (TimeLimit, Timeout y eventos intermedios) se omiten. El trial impone su propio límite de 10 minutos y su cuota total; el guion del router tarda aproximadamente cinco minutos. Los rechazos estructurados se conservan en el expediente sin volver a marcar.
