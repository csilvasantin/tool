...
function setup(){
 const db=new DatabaseSync(':memory:');for(const file of ['0001_installer_portal.sql','0002_retailer_portal.sql','0003_portal_mcp.sql','0004_retailer_site_imports.sql','0005_retailer_site_circuits.sql'])db.exec(readFileSync(new URL('./migrations/'+file,import.meta.url),'utf8'));
